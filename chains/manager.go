...
import (
	...
	"github.com/lasthyphen/paaro/api/health"
	...
	"github.com/lasthyphen/paaro/snow/engine/dijets/state"
	...
	"github.com/lasthyphen/paaro/snow/networking/sender"
	...
	"github.com/lasthyphen/paaro/vms/metervm"

	dbManager "github.com/lasthyphen/paaro/database/manager"

	avcon "github.com/lasthyphen/paaro/snow/consensus/dijets"
	aveng "github.com/lasthyphen/paaro/snow/engine/dijets"
	avbootstrap "github.com/lasthyphen/paaro/snow/engine/dijets/bootstrap"

	smcon "github.com/lasthyphen/paaro/snow/consensus/snowman"
	smeng "github.com/lasthyphen/paaro/snow/engine/snowman"
	smbootstrap "github.com/lasthyphen/paaro/snow/engine/snowman/bootstrap"
)
...
func (m *manager) buildChain(chainParams ChainParameters, sb Subnet) (*chain, error) {
	...
	case vertex.DAGVM:
		...
		if err != nil {
			return nil, fmt.Errorf("error while creating new dijets vm %w", err)
		}
	case block.ChainVM:
	...
	default:
		return nil, fmt.Errorf("the vm should have type dijets.DAGVM or snowman.ChainVM. Chain not created")
	}
...
// Create a DAG-based blockchain that uses Dijets
func (m *manager) createDijetsChain(
	...
	if err := engine.Initialize(aveng.Config{
		...
		return nil, fmt.Errorf("error initializing dijets engine: %w", err)
	}
