...
import (
	...
	"github.com/lasthyphen/coreth/eth"
	"github.com/lasthyphen/coreth/params"
	"github.com/lasthyphen/coreth/rpc"

	accountKeystore "github.com/lasthyphen/coreth/accounts/keystore"
)
...
func TestSetPreferenceRace(t *testing.T) {
	...
	utxo := &djtx.UTXO{
		UTXOID: utxoID,
		Asset:  djtx.Asset{ID: vm1.ctx.AVAXAssetID},
		Out: &secp256k1fx.TransferOutput{
			Amt: importAmount,
			OutputOwners: secp256k1fx.OutputOwners{
				Threshold: 1,
...
func TestConflictingTransitiveAncestryWithGap(t *testing.T) {
	...
	utxo0ID := djtx.UTXOID{}
	utxo1ID := djtx.UTXOID{OutputIndex: 1}
