...
func (service *Service) IssueTx(r *http.Request, args *api.FormattedTx, reply *api.JSONTxID) error {
	service.vm.ctx.Log.Debug("DVM: IssueTx called with %s", args.Tx)
...
func (service *Service) GetAddressTxs(r *http.Request, args *GetAddressTxsArgs, reply *GetAddressTxsReply) error {
	service.vm.ctx.Log.Debug("DVM: GetAddressTxs called with address=%s, assetID=%s, cursor=%d, pageSize=%d", args.Address, args.AssetID, args.Cursor, args.PageSize)
...
func (service *Service) GetTxStatus(r *http.Request, args *api.JSONTxID, reply *GetTxStatusReply) error {
	service.vm.ctx.Log.Debug("DVM: GetTxStatus called with %s", args.TxID)
...
func (service *Service) GetTx(r *http.Request, args *api.GetTxArgs, reply *api.GetTxReply) error {
	service.vm.ctx.Log.Debug("DVM: GetTx called with %s", args.TxID)
...
func (service *Service) GetUTXOs(r *http.Request, args *api.GetUTXOsArgs, reply *api.GetUTXOsReply) error {
	service.vm.ctx.Log.Debug("DVM: GetUTXOs called for with %s", args.Addresses)
...
func (service *Service) GetAssetDescription(_ *http.Request, args *GetAssetDescriptionArgs, reply *GetAssetDescriptionReply) error {
	service.vm.ctx.Log.Debug("DVM: GetAssetDescription called with %s", args.AssetID)
...
func (service *Service) GetBalance(r *http.Request, args *GetBalanceArgs, reply *GetBalanceReply) error {
	service.vm.ctx.Log.Debug("DVM: GetBalance called with address: %s assetID: %s", args.Address, args.AssetID)
...
func (service *Service) GetAllBalances(r *http.Request, args *GetAllBalancesArgs, reply *GetAllBalancesReply) error {
	service.vm.ctx.Log.Debug("DVM: GetAllBalances called with address: %s", args.Address)
...
func (service *Service) CreateAsset(r *http.Request, args *CreateAssetArgs, reply *AssetIDChangeAddr) error {
	service.vm.ctx.Log.Debug("DVM: CreateAsset called with name: %s symbol: %s number of holders: %d number of minters: %d",
		args.Name,
		args.Symbol,
...
func (service *Service) CreateFixedCapAsset(r *http.Request, args *CreateAssetArgs, reply *AssetIDChangeAddr) error {
	service.vm.ctx.Log.Debug("DVM: CreateFixedCapAsset called with name: %s symbol: %s number of holders: %d",
		args.Name,
		args.Symbol,
		len(args.InitialHolders),
	)
...
func (service *Service) CreateVariableCapAsset(r *http.Request, args *CreateAssetArgs, reply *AssetIDChangeAddr) error {
	service.vm.ctx.Log.Debug("DVM: CreateVariableCapAsset called with name: %s symbol: %s number of minters: %d",
		args.Name,
		args.Symbol,
		len(args.MinterSets),
	)
...
func (service *Service) CreateNFTAsset(r *http.Request, args *CreateNFTAssetArgs, reply *AssetIDChangeAddr) error {
	service.vm.ctx.Log.Debug("DVM: CreateNFTAsset called with name: %s symbol: %s number of minters: %d",
		args.Name,
		args.Symbol,
		len(args.MinterSets),
	)
...
func (service *Service) CreateAddress(r *http.Request, args *api.UserPass, reply *api.JSONAddress) error {
	service.vm.ctx.Log.Debug("DVM: CreateAddress called for user '%s'", args.Username)
...
func (service *Service) ListAddresses(_ *http.Request, args *api.UserPass, response *api.JSONAddresses) error {
	service.vm.ctx.Log.Debug("DVM: ListAddresses called for user '%s'", args.Username)
...
func (service *Service) ExportKey(r *http.Request, args *ExportKeyArgs, reply *ExportKeyReply) error {
	service.vm.ctx.Log.Debug("DVM: ExportKey called for user %q", args.Username)
...
func (service *Service) ImportKey(r *http.Request, args *ImportKeyArgs, reply *api.JSONAddress) error {
	service.vm.ctx.Log.Debug("DVM: ImportKey called for user '%s'", args.Username)
...
func (service *Service) SendMultiple(r *http.Request, args *SendMultipleArgs, reply *api.JSONTxIDChangeAddr) error {
	service.vm.ctx.Log.Debug("DVM: SendMultiple called with username: %s", args.Username)
	...
	djtx.SortTransferableOutputs(outs, service.vm.codec)
...
func (service *Service) Mint(r *http.Request, args *MintArgs, reply *api.JSONTxIDChangeAddr) error {
	service.vm.ctx.Log.Debug("DVM: Mint called with username: %s", args.Username)
...
func (service *Service) SendNFT(r *http.Request, args *SendNFTArgs, reply *api.JSONTxIDChangeAddr) error {
	service.vm.ctx.Log.Debug("DVM: SendNFT called with username: %s", args.Username)
...
func (service *Service) MintNFT(r *http.Request, args *MintNFTArgs, reply *api.JSONTxIDChangeAddr) error {
	service.vm.ctx.Log.Debug("DVM: MintNFT called with username: %s", args.Username)
...
// ImportDJTX is a deprecated name for Import.
func (service *Service) ImportDJTX(_ *http.Request, args *ImportArgs, reply *api.JSONTxID) error {
...
func (service *Service) Import(_ *http.Request, args *ImportArgs, reply *api.JSONTxID) error {
	service.vm.ctx.Log.Debug("DVM: Import called with username: %s", args.Username)
...
// ExportDJTXArgs are arguments for passing into ExportAVA requests
type ExportDJTXArgs struct {
	...
	// ID of the address that will receive the DJTX. This address includes the
...
// Returns the ID of the newly created atomic transaction
func (service *Service) ExportDJTX(_ *http.Request, args *ExportDJTXArgs, reply *api.JSONTxIDChangeAddr) error {
	return service.Export(nil, &ExportArgs{
		ExportDJTXArgs: *args,
		AssetID:        service.vm.ctx.DJTXAssetID.String(),
	}, reply)
}
...
func (service *Service) Export(_ *http.Request, args *ExportArgs, reply *api.JSONTxIDChangeAddr) error {
	service.vm.ctx.Log.Debug("DVM: Export called with username: %s", args.Username)
