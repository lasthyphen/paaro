...
// Note that since an Dijets network has exactly one Platform Chain,
...
// BuildGenesis build the genesis state of the Platform Chain (and thereby the Dijets network.)
