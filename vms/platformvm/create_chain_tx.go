...
func (tx *UnsignedCreateChainTx) SemanticVerify(
	...
	if err := tx.Verify(vm.ctx, vm.codec, createBlockchainTxFee, vm.ctx.DJTXAssetID); err != nil {
...
func (vm *VM) newCreateChainTx(
	...
	return tx, utx.Verify(vm.ctx, vm.codec, createBlockchainTxFee, vm.ctx.DJTXAssetID)
}
