// (c) 2020, Dijets, Inc. All rights reserved.
...
// Client for Dijets Health API Endpoint
type Client struct {
...
// GetLiveness returns a health check on the Dijets node
...
// Health returns a health check on the Dijets node
