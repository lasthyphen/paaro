...
func TestEngineAdd(t *testing.T) {
	...
	vtx := &dijets.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
		ParentsV: []dijets.Vertex{
			&dijets.TestVertex{TestDecidable: choices.TestDecidable{
				IDV:     ids.GenerateTestID(),
	...
	manager.ParseVtxF = func(b []byte) (dijets.Vertex, error) {
	...
	manager.ParseVtxF = func(b []byte) (dijets.Vertex, error) { return nil, errFailedParsing }
...
func TestEngineQuery(t *testing.T) {
	...
	gVtx := &dijets.TestVertex{TestDecidable: choices.TestDecidable{
		IDV:     ids.GenerateTestID(),
		StatusV: choices.Accepted,
	}}
	mVtx := &dijets.TestVertex{TestDecidable: choices.TestDecidable{
		IDV:     ids.GenerateTestID(),
		StatusV: choices.Accepted,
	}}

	vts := []dijets.Vertex{gVtx, mVtx}
	...
	manager.GetVtxF = func(id ids.ID) (dijets.Vertex, error) {
		switch id {
		case gVtx.ID():
			return gVtx, nil
		case mVtx.ID():
	...
	vertexed := new(bool)
	manager.GetVtxF = func(vtxID ids.ID) (dijets.Vertex, error) {
		if *vertexed {
...
func TestEngineMultipleQuery(t *testing.T) {
	...
	config.Params = dijets.Parameters{
...
func TestEngineAbandonResponse(t *testing.T) {
	...
	manager.GetVtxF = func(id ids.ID) (dijets.Vertex, error) { return nil, errUnknownVertex }
...
func TestEngineRejectDoubleSpendTx(t *testing.T) {
	...
	manager.BuildVtxF = func(_ uint32, _ []ids.ID, txs []snowstorm.Tx, _ []ids.ID) (dijets.Vertex, error) {
		return &dijets.TestVertex{
			TestDecidable: choices.TestDecidable{
				IDV:     ids.GenerateTestID(),
				StatusV: choices.Processing,
			},
			ParentsV: []dijets.Vertex{gVtx, mVtx},
			HeightV:  1,
			TxsV:     txs,
			BytesV:   []byte{1},
		}, nil
...
func TestEngineReissue(t *testing.T) {
	...
	lastVtx := new(dijets.TestVertex)
	manager.BuildVtxF = func(_ uint32, _ []ids.ID, txs []snowstorm.Tx, _ []ids.ID) (dijets.Vertex, error) {
		lastVtx = &dijets.TestVertex{
			TestDecidable: choices.TestDecidable{
				IDV:     ids.GenerateTestID(),
				StatusV: choices.Processing,
			},
...
func TestEngineParentBlockingInsert(t *testing.T) {
	...
	parentVtx := &dijets.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
		ParentsV: []dijets.Vertex{missingVtx},
		HeightV:  2,
		BytesV:   []byte{0, 1, 2, 3},
	}

	blockingVtx := &dijets.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
		ParentsV: []dijets.Vertex{parentVtx},
		HeightV:  3,
		BytesV:   []byte{0, 1, 2, 3},
	}
...
func TestEngineDuplicatedIssuance(t *testing.T) {
	...
	manager.BuildVtxF = func(uint32, []ids.ID, []snowstorm.Tx, []ids.ID) (dijets.Vertex, error) {
...
func TestEngineBubbleVotes(t *testing.T) {
	...
	missingVtx := &dijets.TestVertex{TestDecidable: choices.TestDecidable{
		IDV:     ids.GenerateTestID(),
		StatusV: choices.Unknown,
	}}

	pendingVtx0 := &dijets.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
		ParentsV: []dijets.Vertex{vtx, missingVtx},
		HeightV:  1,
		TxsV:     []snowstorm.Tx{tx1},
		BytesV:   []byte{1},
	}

	pendingVtx1 := &dijets.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
		ParentsV: []dijets.Vertex{pendingVtx0},
		HeightV:  2,
		TxsV:     []snowstorm.Tx{tx2},
		BytesV:   []byte{2},
	}
...
func TestAbandonTx(t *testing.T) {
	...
	vtx0 := &dijets.TestVertex{ // Contains tx0, which will fail verification
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Unknown,
		},
		ParentsV: []dijets.Vertex{gVtx},
