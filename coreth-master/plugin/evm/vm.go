...
import (
	...
	coreth "github.com/lasthyphen/paaro/coreth/chain"
	...
	commonEng "github.com/lasthyphen/paaro/snow/engine/common"
	avalancheJSON "github.com/lasthyphen/paaro/utils/json"
)
...
func (vm *VM) CreateHandlers() (map[string]*commonEng.HTTPHandler, error) {
	...
	djtxAPI, err := newHandler("djtx", &AvaxAPI{vm})
	if err != nil {
