...
var (
	errUnhealthy = errors.New("dijets consensus is not healthy")
...
// Topological performs the dijets algorithm by utilizing a topological sort
...
// Initialize implements the Dijets interface
...
// VertexIssued implements the Dijets interface
...
// Quiesce implements the Dijets interface
func (ta *Topological) Quiesce() bool { return ta.cg.Quiesce() }

// Finalized implements the Dijets interface
