...
AvalancheGo's build script downloads Coreth, compiles it, and places the binary into the `paaro/build/plugins` directory.
...
Full documentation for the C-Chain's API can be found [here.](https://docs.djtx.network/build/paaro-apis/contract-chain-c-chain-api)
