...
func TestBootstrapperSingleFrontier(t *testing.T) {
	...
	manager.ParseVtxF = func(vtxBytes []byte) (dijets.Vertex, error) {
		switch {
...
func TestBootstrapperTxDependencies(t *testing.T) {
	...
	vtx1 := &dijets.TestVertex{
		...
		ParentsV: []dijets.Vertex{vtx0}, // Depends on vtx0
		HeightV:  1,
...
func TestBootstrapperFilterAccepted(t *testing.T) {
	...
	vtx0 := &dijets.TestVertex{TestDecidable: choices.TestDecidable{
		IDV:     vtxID0,
		StatusV: choices.Accepted,
	}}
	vtx1 := &dijets.TestVertex{TestDecidable: choices.TestDecidable{
		IDV:     vtxID1,
		StatusV: choices.Accepted,
	}}
...
func TestRestartBootstrapping(t *testing.T) {
	...
	vtx3 := &dijets.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     vtxID3,
			StatusV: choices.Unknown,
		},
		ParentsV: []dijets.Vertex{vtx2},
		HeightV:  3,
		BytesV:   vtxBytes3,
	}
	vtx4 := &dijets.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     vtxID4,
			StatusV: choices.Unknown,
		},
	...
	vtx5 := &dijets.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     vtxID5,
			StatusV: choices.Unknown,
		},
		ParentsV: []dijets.Vertex{vtx4},
		HeightV:  4,
		BytesV:   vtxBytes5,
	}
